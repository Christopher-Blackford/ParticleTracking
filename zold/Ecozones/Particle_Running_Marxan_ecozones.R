...
Boundary_length <- gTouches(Marxan_spatial, byid = TRUE) #tells you if a cell is touching another cell
...
dir.create(output_directory)
output_directory <- paste0(output_directory, "/", output_added_directory)
dir.create(output_directory)
...
Marxan_spatial <- sp::merge(Marxan_spatial, Marxan_output, by = "Poly_ID", all.x = TRUE)

shapefile_directory <- paste0("./Marxan/To_shapefile/", Depth_class, "/pld", pld, "/", output_added_directory)
