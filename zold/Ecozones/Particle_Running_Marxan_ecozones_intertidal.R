...
R_file <- read.csv(paste0("./output_keep/Con_df/hexagon/", Depth_class, "/pld", pld, "/", Depth_class, "_pld", pld, ".csv"))
...
Southern_Shelf <- Ecozones[Ecozones$FID_CA_EZ_ == 1,]; Straight_of_Georgia <- Ecozones[Ecozones$FID_CA_EZ_ == 2,]; Northern_Shelf <- Ecozones[Ecozones$FID_CA_EZ_ == 6,]

Marxan_Southern_Shelf <- Marxan_spatial[Southern_Shelf,]; Marxan_Straight_of_Georgia <- Marxan_spatial[Straight_of_Georgia,]; Marxan_Northern_Shelf <- Marxan_spatial[Northern_Shelf,]

Ecozone_list <- c("Marxan_Southern_Shelf", "Marxan_Straight_of_Georgia", "Marxan_Northern_Shelf")

########################################################################
########################################################################
########################################################################
#What Ecozone do you want to look at?

Marxan_spatial <- Marxan_Northern_Shelf #Options are Marxan_Southern_Shelf, Marxan_Straight_of_Georgia, Marxan_Northern_Shelf
output_added_directory <- "Marxan_Northern_Shelf" #Options are Marxan_Southern_Shelf, Marxan_Straight_of_Georgia, Marxan_Northern_Shelf
...
input_directory <- paste0("K:/Christopher_PhD/Github/ParticleTracking/Marxan/From_R/input/hexagon/", Depth_class)
dir.create(input_directory)
input_directory <- paste0("K:/Christopher_PhD/Github/ParticleTracking/Marxan/From_R/input/hexagon/", Depth_class, "/pld", pld)
dir.create(input_directory)
...
output_directory <- paste0("K:/Christopher_PhD/Github/ParticleTracking/Marxan/From_R/output/hexagon/", Depth_class)
