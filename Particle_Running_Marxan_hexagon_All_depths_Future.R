...
Intertidal <- read.csv(paste0("./output_keep_future/Con_df/hexagon/Intertidal/pld", Intertidal_pld, "/Intertidal_pld", Intertidal_pld, ".csv"))
Nearshore <- read.csv(paste0("./output_keep_future/Con_df/hexagon/Nearshore/pld", Nearshore_pld, "/Nearshore_pld", Nearshore_pld, ".csv"))
Offshore <- read.csv(paste0("./output_keep_future/Con_df/hexagon/Offshore/pld", Offshore_pld, "/Offshore_pld", Offshore_pld, ".csv"))
...
input_directory <- paste0("K:/Christopher_PhD/Github/ParticleTracking/Marxan_future/From_R/input/hexagon/All/", "Int", Intertidal_pld, "_Near", Nearshore_pld, "_Off", Offshore_pld)
...
output_directory <- paste0("K:/Christopher_PhD/Github/ParticleTracking/Marxan_future/From_R/output/hexagon/All")
...
shapefile_directory <- paste0("./Marxan_future/To_shapefile/hexagon/All")
