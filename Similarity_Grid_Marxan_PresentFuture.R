...
Depth_class_Present <- paste0("./Marxan/From_R/output/hexagon/", Depth_class)
Depth_class_Present_PLDs <- list.files(path=Depth_class_directory)
...
for (i in 1:length(Depth_class_plds)){
  ...
  Marxan_Present <- append(Marxan_outputs, Marxan_list)
  }
