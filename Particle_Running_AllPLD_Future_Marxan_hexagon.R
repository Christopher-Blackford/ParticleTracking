...
input_directory <- paste0("K:/Christopher_PhD/Github/ParticleTracking/Marxan_future_AllPLD/From_R/input/hexagon/", Depth_class)
#dir.create(input_directory)
input_directory <- paste0("K:/Christopher_PhD/Github/ParticleTracking/Marxan_future_AllPLD/From_R/input/hexagon/", Depth_class, "/pld", pld)
dir.create(input_directory)
...
input_directions <- read.delim("./Marxan_future_AllPLD/From_R/input.dat", header = TRUE, as.is = TRUE)

input_directory_marxan <- gsub(x = input_directory, pattern = "/", replacement = "\\\\", fixed = TRUE)

output_directory <- paste0("K:/Christopher_PhD/Github/ParticleTracking/Marxan_future_AllPLD/From_R/output/hexagon/", Depth_class)
...
write.table(input_edit, file= "./Marxan_future_AllPLD/From_R/input.dat", row.names=FALSE, sep=",", quote=FALSE)
...
system(paste("K:/Christopher_PhD/Github/ParticleTracking/Marxan_future_AllPLD/From_R/Marxan_x64.exe K:/Christopher_PhD/Github/ParticleTracking/Marxan_future_AllPLD/From_R/input.dat", sep = ""))
...
shapefile_directory <- paste0("./Marxan_future_AllPLD/To_shapefile/hexagon/", Depth_class, "/pld", pld)
